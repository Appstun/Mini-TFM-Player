export namespace TruckersFmApi {
  export async function getTFMSong() {
    try {
  ...
  export async function getTFMPresenter() {
    try {
...
export namespace BrowserData {
  ...
  type BrowserAgent = "Chrome" | "Firefox" | "Edg" | "OPR";
  export function getBrowserAgent(): BrowserAgent | undefined {
    let browser = undefined;
    for (let agent of agents) if (navigator.userAgent.includes(agent)) browser = agent as BrowserAgent;
    return browser;
  }
